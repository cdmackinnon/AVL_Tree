...
class Fraction:
  ...
  def __lt__(self, other):
    #uses cross multiplication to avoid
    #inaccuracies through floating-point representation
    if other.__n * self.__d > other.__d * self.__n:
      return True
    return False
...
if __name__ == '__main__':
  ...
  fraction_tree.insert_element(Fraction(10, 4))
  fraction_tree.insert_element(Fraction(1, 9))
  fraction_tree.insert_element(Fraction(6, 2))
  fraction_tree.insert_element(Fraction(1, 7))
  fraction_tree.insert_element(Fraction(11, 2))
  fraction_tree.insert_element(Fraction(53, 7))

  print(fraction_tree.to_list())
  print(str(fraction_tree))
